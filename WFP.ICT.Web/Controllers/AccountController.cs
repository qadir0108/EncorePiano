...
namespace WFP.ICT.Web.Controllers
{
    ...
    public class AccountController : BaseController
    {
            ...
            try
            {
                ...
                switch (result)
                {
                    case SignInStatus.Success:
                        SetupLoggedInUser(model.Username);

                        return RedirectToLocal(returnUrl);
                    //return Json(new JsonResponse() { IsSucess = true }, JsonRequestBehavior.AllowGet); //RedirectToLocal(returnUrl);
        ...
        //        }
        //        var user = new WFPUser { UserName = model.Email, Email = model.Email };
