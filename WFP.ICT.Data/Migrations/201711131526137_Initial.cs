namespace WFP.ICT.Data.Migrations
{
    ...
    public partial class Initial : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        Notes = c.String(),
                        BenchesUnloadStatus = c.Boolean(nullable: false),
                ...
                c => new
                    {
                        ...
                        AdditionalBenchesStatus = c.Int(nullable: false),
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.TripStatus", "PianoAssignmentId", "dbo.PianoAssignment");
            DropForeignKey("dbo.PianoAssignmentRoute", "PianoAssignmentId", "dbo.PianoAssignment");
            DropForeignKey("dbo.PianoPOD", "PianoAssignmentId", "dbo.PianoAssignment");
            ...
            DropIndex("dbo.TripStatus", new[] { "PianoAssignmentId" });
            ...
            DropIndex("dbo.PianoPOD", new[] { "PianoAssignmentId" });
